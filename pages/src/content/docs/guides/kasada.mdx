...
<CardGrid>
  <LinkCard title="Node.js" description="npm install @proofofbot/client-kasada" href="/web-re-toolkit/packages/kasada/node/" />
  <LinkCard title="Python" description="pip install wre-client-kasada" href="/web-re-toolkit/packages/kasada/python/" />
  <LinkCard title="Go" description="go get .../packages/go/clients/kasada" href="/web-re-toolkit/packages/kasada/go/" />
  <LinkCard title="Rust" description="wre-sdk-kasada by path" href="/web-re-toolkit/packages/kasada/rust/" />
</CardGrid>
